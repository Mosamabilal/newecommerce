                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="{{ asset('uploads/'.$product->image) }}">
                                    <img class="w-100" src="{{ asset('uploads/'.$product->image) }}" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="{{ asset('uploads/'.$product->image_2) }}">
                                    <img class="w-100" src="{{ asset('uploads/'.$product->image_2) }}" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('uploads/'.$product->image_2) }}" alt="Product">
                                </div>
                ...
                <div class="col-lg-7 col-custom">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="price-box mb-2">
                            <span class="regular-price">{{ $product->price. 'PKR'  }}</span>
                        ...
                        <div class="cart-wishlist-btn mb-4">
                            <div class="add-to_cart">
                                <button type="submit" class="btn btn-outline-dark btn-hover-primary" >Add to cart</button>
                            </div>
