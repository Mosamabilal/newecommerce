...
<h2 class="intro-y text-lg font-medium mt-10">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a href="{{route('products.create')}}" type="button" class="btn btn-primary shadow-md mr-2">Add New Category</a>
                        <div class="dropdown">
                            ...
                            @foreach($products as $product)
                                ...
                                <td class="w-40">
                                    ...
                                    <td>
                                        ...
                                        <div class="font-medium  whitespace-nowrap ">{{ $product->categories->name }}</div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{ URL('admin/products/'.$product->id.'/edit') }}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
