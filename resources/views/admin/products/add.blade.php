                    ...
                    @csrf
                        <div class="intro-y box p-5">
                            ...
                            <div>
                                ...
                                <input id="crud-form-1" name="price" type="number" class="form-control w-full" placeholder="Product Price">
                            </div>
                            ...
                            <div class="mt-3">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Upload Imgage 1</label>
